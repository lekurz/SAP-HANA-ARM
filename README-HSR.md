...
[![Deploy to Azure](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Flekurz%2FSAP-HANA-ARM%2Fmaster%2Fazuredeploy-hsr.json)
## Machine Info
...
## Installation Media
Installation media for SAP HANA should be downloaded and placed in the SapBits folder. You will need to provide the URI for the container where they are stored, for example https://yourBlobName.blob.core.windows.net/yourContainerName. For more information on how to upload files to Azure please go [here](https://github.com/lekurz/SAP-HANA-ARM/blob/master/UploadToAzure.md)  Specifically you need to download SAP package 51052325, which should consist of four files:
```
51052325_part1.exe
51052325_part2.rar
51052325_part3.rar
...
To deploy from the portal using the Azure portal, you can use the [![Deploy to Azure](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Flekurz%2FSAP-HANA-ARM%2Fmaster%2Fazuredeploy-hsr.json) button to bring up the template in your subscription and fill out the parameters.
...
New-AzureRmResourceGroupDeployment -Name HANADeployment -ResourceGroupName HANADeploymentRG `
  -TemplateUri https://raw.githubusercontent.com/lekurz/SAP-HANA-ARM/master/azuredeploy-hsr.json `
...
az group deployment create \
    ...
    --template-uri "https://raw.githubusercontent.com/lekurz/SAP-HANA-ARM/master/azuredeploy-hsr.json" \
